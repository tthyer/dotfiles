...
Ghostty config is linked to `~/.config/ghostty/config.ghostty`. Put machine-specific overrides in `~/.config/ghostty/local.ghostty`; that file is optional and intentionally not tracked.
